...
const GainersLosersList = ({ data }) => {
  ...
  return (
    <>
      ...
      >
        <Tab icon={<TrendingUpIcon />} iconPosition="start" value="gainers" label="Top Gainers" />
        <Tab icon={<TrendingDownIcon />} iconPosition="start" value="losers" label="Top Losers" />
        <Tab icon={<BarChartIcon />} iconPosition="start" value="active" label="Most Active" />
      </Tabs>
